...
import {  
  ...
  //@Returns array of two transaction signatures [token transaction, token fee transaction]
  ...
  export const send_with_fee = async (
    ...
    export const basic_send = async (
      ...
      connection: Connection
        ...
        //get or create token account for receiver (paid for by fee_payer_keypair)
        ...
        const signature = await sendAndConfirmTransaction(
          ...
          {commitment: 'processed', maxRetries: 5} //experimenting with these options... faster transactions can be achieved with commitment: 'processed' but there is a chance transaction gets dropped after receiving signature.
